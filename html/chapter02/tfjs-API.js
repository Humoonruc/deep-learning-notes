...
// 张量对应元素相乘
// 若两个张量的size不同，size较小的要扩展为size较大的，再相乘
tf.mul(k1, year).print(); // (2*3)矩阵乘(0)标量，标量扩展为与矩阵具有相同size的矩阵
tf.mul(k1, b).print(); // (2*3)矩阵乘(3)向量，（行）向量扩展为与矩阵具有相同size的矩阵
tf.mul(k2, k3).print(); // (3*2)矩阵乘(3*1)矩阵，后者扩展为与前者具有相同size的矩阵
